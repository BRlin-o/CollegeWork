/**************** ADC4.C ****ADC0804實習板*************
*動作：輸入類比電壓，中斷方式讀取數位資料，在LCD顯示電壓值
...
void EX0_SUB(void) interrupt 0
{
	...
	AD_RD=0;	       //轉換完畢，讀取數位資料
	temp=P2;     	   //8-bit資料轉換成32-bit
	temp=temp*500/255; //數位資料轉換成電壓值
	LCD_Disp(temp);    //LCD顯示ADC的資料
	AD_RD=1;	       //ADC停止讀取
